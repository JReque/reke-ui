 ...
 * to compile.
 */
import type { Cleanup, ExpandedRowElement, GetRowKey, RowKey } from '../index.js';
...
type _ExpandReturn = Assert<
  HasLitBrand<ReturnType<ExpandedRowElement>> extends false ? true : false
>;
